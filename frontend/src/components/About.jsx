const About = () => {
  return (
    <section className="container mx-auto my-16 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24 px-4">
      <div>
      ...
      <div className="grid grid-rows-2 gap-4 md:gap-5 max-h-fit max-w-full z-10">
        <div className="grid grid-cols-2 gap-4 md:gap-5">
          <div className="bg-main rounded-md p-6 md:p-8 lg:p-10 text-center">
            ...
            <p className="text-sm md:text-base lg:text-xl">Years of Experience</p>
          </div>
        ...
        <div className="bg-white text-main items-center p-6 md:p-8 lg:p-10 rounded-md text-center">
          ...
          <p className="text-sm md:text-base lg:text-xl">Successful Students Exceeding in Academics</p>
        </div>
      </div>
    </section>
  );
