...
const Hero = () => {
  return (
    <section
      id="home"
      className="container mx-auto min-h-[80vh] md:min-h-[90vh] text-center mb-16 relative overflow-hidden mt-8 lg:mt-16"
    >
      ...
      <img
        loading="lazy"
        className="mx-auto mt-2 w-1/2 sm:w-2/5 md:w-1/3"
        src={underline}
        alt="Underline"
      />
      ...
      <img
        loading="lazy"
        src={studentImage}
        className="hero-student-image mx-auto max-w-[90%] md:max-w-[70%] relative"
        alt="Student Image 1"
      />
